...
public class NewManualSyringePumpController: ObservableObject {
    var communicator: NewManualSyringePumpCommunicator?
    ...
    private func connectToPump() {
        do {
            communicator = try NewManualSyringePumpCommunicator(address: address, port: Int(port), timeout: timeout)
            isConnected = true
